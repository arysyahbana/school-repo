<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    {{-- Arsip --}}
    <li class="menu-item {{ request()->routeIs('arsip.*') ? 'active' : '' }}">
    ...
    @if (in_array($jabatan, ['admin', 'kepala_madrasah', 'kaur']))
    <li class="menu-item {{ request()->routeIs('akses-arsip.*') ? 'active' : '' }}">
        <a href="{{ route('akses-arsip.index') }}" class="menu-link">
